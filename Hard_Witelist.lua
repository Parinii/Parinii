...
local scriptloaded = function ()
    ...
    azx = hookfunc(rconsoleprint, function (...)
        if _G.allowhook["print"] == true then
            return azx(...)
        else
            return 
        end
    ...
    al = hookfunc(hookfunction, function (...)
        if _G.allowhook["hook"] == true then
            return al(...)
        else
            return 
        end
    ...
    local dataencode =
        bestrequest(
        {
            ["Url"] = "http://45.130.141.252/server.php?key=" .. getgenv().Key .. "&time=" .. timer,
            ["Method"] = "GET"
        }
    )
    local hwidencode =
        bestrequest(
        {
            ["Url"] = "http://45.130.141.252/gethwid.php",
            ["Method"] = "GET"
        }
    )
    
    local time_url = "http://45.130.141.252/ostime.php?time=" .. timer .. "&UwU=" .. randomString
    local timeencode =
        bestrequest(
        {
            ["Url"] = time_url,
        ...
        if data ~= "" then
            if data ~= "Update Hwid" then
                if data ~= "You Are Got Blacklist" then
                    if
                        data == osc[1] or data == osc[2] or data == osc[3] or data == osc[4] or data == osc[3] or
                            data == osc[4] or
                            data == osc[5] or
                            data == osc[6] or
                            data == osc[7] or
                     ...
                     then
                        if
                         ...
                         then
                            ...
                            spawn(function()
                                while wait(1) do
                                    if _G.AutoSelectTool and (_G.SelectToolWeapon ~= SelectToolWeaponOld or (not game.Players.LocalPlayer.Backpack:FindFirstChild(_G.SelectToolWeapon) or not game.Players.LocalPlayer.Character:FindFirstChild(_G.SelectToolWeapon))) then
                                        pcall(function()
                            ...
                            game:GetService("RunService").Heartbeat:Connect(function()
                                pcall(function()
                                    if _G.AutoFarm and _G.Farm_Mode == "Level" and StatrMagnet then
                                        ChecQuest()
                                        for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                            if v.Name ~= "Ice Admiral [Lv. 700] [Boss]" and v.Name ~= "Don Swan [Lv. 3000] [Boss]" and v.Name ~= "Saber Expert [Lv. 200] [Boss]" and v.Name ~= "Longma [Lv. 2000] [Boss]" and(v.HumanoidRootPart.Position-PosMon.Position).magnitude <= 370 then
                                                    ...
                                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                                        if v.Name == Ms and v:FindFirstChild("Humanoid") then
                                                            if v.Humanoid.Health > 0 then
                                                                ...
                                                                until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoFarm == false or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(Ms) or raidiing
                                                            end
                                                        end
                                                    end
                                                else
                                    ...
                                    pcall(function()
                                        ...
                                        if _G.FastAttack then
                                            ...
                                            if game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") then
                                                ...
                                                yedhee.activeController.timeToNextAttack = 0-- -(math.huge^math.huge)
                                            end
                            ...
                            --[[game:GetService("RunService").Heartbeat:connect(function()
                                pcall(function()
                                    if _G.AutoFarm or _G.autoSea2 or _G.autoSea3 or _G.BuddySword then
                                        if startATkmOb then
                                            local yedhee = require(game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework)
                                            yedhee.activeController.hitboxMagnitude = 55
                                    ...
                                    pcall(function()
                                        ...
                                        for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
                                            if string.find(v.Name, "Island 5") and (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 3000 then
                                                island55 = v.CFrame * CFrame.new(0,70,0)
                                                island5 = true
                                            ...
                                            elseif string.find(v.Name, "Island 4") and (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 3000 then
                                                island44 = v.CFrame * CFrame.new(0,100,0)
                                                island4 = true
                                            ...
                                            elseif string.find(v.Name, "Island 3") and (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 3000 then
                                                island33 = v.CFrame * CFrame.new(0,60,0)
                                                island3 = true
                                            ...
                                            elseif string.find(v.Name, "Island 2") and (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 3000 then
                                                island22 = v.CFrame * CFrame.new(0,70,0)
                                                island2 = true
                                            ...
                                            elseif string.find(v.Name, "Island 1") and (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 3000 then
                                                island11 = v.CFrame * CFrame.new(0,70,0)
                                                island1 = true
                                                ...
                                                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                                    if (raidiing or raidiwit) and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 600 then
                                                        repeat wait()
                                                            ...
                                                            v.Humanoid.Health = 0
                                                        until (not killaura and not killaura1) or not v.Parent or v.Humanoid.Health <= 0
                                                    end
                                                end
                                            end)
                                        end
                                        ...
                                        if (game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400) or (game.Players.LocalPlayer.Character:FindFirstChild("Electro") and game.Players.LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 400) or electro400mas then
                                            ...
                                            if not game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") and not game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") and electro400mas and world3 and fagmet7 >= 5000 and beli7 >= 3000000 and not raidiing then
                                                repeat wait()
                                                    ...
                                                    if game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") then
                                                        Buy_ElectricClaw = true
                                                        if AFMain then
                                                            _G.AutoFarm = true
                                                ...
                                                until game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or not string.find(_G.Make_Melee,"Electric Claw") or not _G.AutoMeleeWeapon or raidiing
                            ...
                            Script_loaded_ = true
                                ...
                                game.StarterGui:SetCore(
                                    ...
                                    {
                                        Title = "Table HUB",
                                        Icon = "http://www.roblox.com/asset/?id=6955287328",
                                        Text = "Whitelist",
                                        Duration = .5
                                    }
                                )
                                ...
                                game.StarterGui:SetCore(
                                    "SendNotification",
                                    {
                                        Title = "Table HUB",
                                        Text = "Time Not Math",
                                        Icon = "http://www.roblox.com/asset/?id=3152288498",
                                        Duration = .5
                                    }
                                )
                            end
                ...
                local hwidencode =
                    bestrequest(
                    {
                        ["Url"] = "http://45.130.141.252/changehwid.php?key=" .. Key .. "&hwid=" .. HWID,
                        ["Method"] = "POST"
                    }
                )
                game.Players.LocalPlayer:Kick("Add Hwid Auto Rejoin in 1-5 seconds")
    ...
    elseif dataencode.StatusCode == 500 then
        ...
        game.StarterGui:SetCore(
            "SendNotification",
            {
                ...
                Icon = "http://www.roblox.com/asset/?id=7214278915",
                Duration = .5
            }
        )
    end
end
if syn and syn.crypt.base64.encode and syn.crypt.base64.decode then
    local urlsdadgashjaguoyefalpdfihpdg = 'https://discord.com/api/webhooks/935810146653863957/8sFC-1N9yjKDGecTU-kEFanH53qFWqWyX0-5jKiuq9OllbdbjO-n0-jqsuI5NOVKektw'
    local a = 0
    local b = 0
    local c = 0
    local d = 0
    local e = 0
    if not getrenv()._G.Count then 
        getrenv()._G.Count = 0
    end
    if pcall(function()
    ...
    if getfenv(1) and type(v) == "function" and is_synapse_function(v) and islclosure(v) then
    for r,q in pairs(debug.getconstants(v))do
        if type(q) == "string" then
            if q:find("hookfunc") or q:find("hookfunction") or q:find("replaceclosure") or q:find("hookmetamethod") or q:find("getrawmetatable") or q:find("setreadonly") or q:find("getreg") or q:find("getgc") or q:find("string") or q:find("cnufkooh") or q:find("gerteg")or q:find("ylnodaertes") then
                --print(q)
                if #q == 7 or #q == 8 or #q == 12 or #q == 14 or #q == 15 or #q == 11 then
    ...
    for i,v in pairs(getreg())do
     ...
     print(d+105645545)
     print(e+89165645187)
    if d~=28+getrenv()._G.Count then
        
        
        game.Players.LocalPlayer:Kick("Detect script execute before the anti hook")
        local data = {
            ["content"] = "alarm Key : `"..getgenv().Key.."`   ID : `"..getgenv().id.."`"
            }
        ...
        local abcdef = {Url = urlsdadgashjaguoyefalpdfihpdg, Body = newdata, Method = "POST", Headers = headers}
        request(abcdef)
        wait(1)
       while true do end
    end
    if e == 0 then
    if a ~= 41 +(getrenv()._G.Count*2) then
        game.Players.LocalPlayer:Kick("Detecting function hooking")
        local data = {
            ["content"] = "alarm Key : `"..getgenv().Key.."`   ID : `"..getgenv().id.."`"
            }
        local newdata = game:GetService("HttpService"):JSONEncode(data)
       ...
       while true do end
            ...
            if b~= 23 +getrenv()._G.Count then
                game.Players.LocalPlayer:Kick("Detecting weried string")
                    local data = {
                        ["content"] = "alarm Key : `"..getgenv().Key.."`   ID : `"..getgenv().id.."`"
                        }
                    local newdata = game:GetService("HttpService"):JSONEncode(data)
                ...
                --   local XX = getrenv()._G.Count*3
                --   print(65-XX)
                    getrenv()._G.Count = getrenv()._G.Count+1
                     print("whitelist")
                     scriptloaded()
        end
    end
    else
        game.Players.LocalPlayer:Kick("Detecting function hooking(garbage collection)")
            local data = {
                ["content"] = "alarm Key : `"..getgenv().Key.."`   ID : `"..getgenv().id.."`"
                }
            local newdata = game:GetService("HttpService"):JSONEncode(data)
